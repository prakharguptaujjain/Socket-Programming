...
#Importing socket and threading module for multi-threading
import socket
import threading

#This function helps to handle multiple clients
...
#Created a sever_socket object
server_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)

#Set host address to '' so that the server socket 
...
# wait for incoming connections and spawn a new thread to handle each one
while True:
